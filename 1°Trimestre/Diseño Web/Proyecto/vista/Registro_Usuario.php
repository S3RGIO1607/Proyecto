...
<body>
    ...
    <body class="Tab_Registro">
    <div class="container_RU">
        <h2 class="RU">Registro de Usuario</h2>
        <form action="procesar_registro.php" method="POST">
            ...
            <div class="form-group">
                <label for="referencia_personal">Referencia Personal</label>
                <input type="text" class="form-control" id="referencia_personal" name="referencia_personal">
            </div>
            <div class="form-group">
                <label for="telefono_referencia_personal">Teléfono de Referencia Personal</label>
                <input type="number" class="form-control" id="telefono_referencia_personal" name="telefono_referencia_personal">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tipo_usuario" name="tipo_usuario" required>
                    ...
                    <option value="Sup_Bodega">Supervisor de Bodega</option>
