...
$sql = "SELECT numero_documento, nombre, correo, contrasena, direccion, telefono, nivel_educativo, referencia_personal, telefono_referencia_personal, eps, tipo_usuario FROM usuario WHERE id_usuario = ?";
$stmt = $conexion->prepare($sql);
$stmt->execute([$userId]); // Pasar el parámetro directamente aquí
...
$nivel_educativo = $result['nivel_educativo'];
$referencia_personal = $result['referencia_personal'];
$telefono_referencia_personal = $result['telefono_referencia_personal'];
$eps = $result['eps'];
...
<head>
    ...
    <title>Perfil - Casa de Eventos Aaron</title>
...
<body>
    ...
    <div class="container">
        <nav class="b">
            ...
            <ul class="f">
                <!-- Elementos del menú -->
                <li class="g">
                    <a class="h" href="../vista/dashboard.html" target="_self">
                        <!-- Icono del Dashboard -->
                ...
                <li class="g">
                    ...
                    <ul class="j">
                        ...
                        <li>
                            <a href="../vista/404.html" target="_self">Actualizar y Eliminar</a>
                        </li>
                    </ul>
                </li>
                <li class="g">
    ...
    <body>
    <section class="bienvenida container mt-5 text-center">
        <div class="Perfil_Adm">
        <svg xmlns="http://www.w3.org/2000/svg" class="icono-usuario mb-3" fill="currentColor" viewBox="0 0 16 16">
            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1"/>
        </svg>
        <h1>Bienvenida</h1>
        <p>¡Hola! Bienvenido/a a tu perfil.</p>
        <div class="perfil-usuario card p-4 shadow">
            <div class="d-flex align-items-center">
                <div class="datos-usuario">
                    <h2>Datos De Usuario</h2>
                    <p>Correo electrónico: <span><?php echo htmlspecialchars($email); ?></span></p>
                    <p>Teléfono: <span><?php echo htmlspecialchars($telefono); ?></span></p>
                    <p>Dirección: <span><?php echo htmlspecialchars($direccion); ?></span></p>
                    <div class="botones mt-3">
                        <a href="../vista/Arron.html"  class="btn">Cerrar sesión</a>
                    </div>
                </div>
            </div>
        </div>
