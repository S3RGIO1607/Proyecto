    ...
    <div class="container">
            ...
            <ul class="f">
                ...
                <li class="g">
                    ...
                    <ul class="j">
                        ...
                        <li>
                            <a href="../vista/Consulta_Usuario_Administrador.html" target="_self">Consultar</a>
                        </li>
                    </ul>
                </li>
                <li class="g">
                    ...
                    <ul class="j">
                        ...
                        <li>
                            <a href="../vista/Consulta_Producto_Administrador.html" target="_self">Consultar</a>
                        </li>
                    </ul>
                </li>
                <li class="g">
                    ...
                    <ul class="j">
                        <li>
                            <a href="../vista/Consulta_Alquiler_Administrador.html" target="_self">Consultar</a>
                        </li>
                    </ul>
                </li>
                <li class="g">
                    ...
                    <ul class="j">
                        <li>
                            <a href="../vista/Consulta_Pre-Facrura_Administrador.html" target="_self">Consultar</a>
                        </li>
                    </ul>
                </li>
                <li class="g">
                    ...
                    <ul class="j">
                        <li>
                            <a href="../vista/Registrar_paquetes.html" target="_self">Registrar</a>
                        </li>
                        <li>
                            <a href="../vista/Consulta_Producto_Administrador.html" target="_self">Consultar</a>
                        </li>
                ...
                <li class="g">
                    ...
                    <ul class="j">
                        ...
                        <li>
                            <a href="../vista/Consulta_Servisio_Administrador.html" target="_self">Consultar</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <body class="Tab_Consulta">
            <div class="container_TC">
                <h1 class="h1_TC">Consulta de Servicios</h1>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody id="rentalTable">
                                ...
                                <tr>
                                    ...
                                    <td>Servicio de catering para eventos</td>
                                    <td>2500000</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Servicio de Decoración</td>
                                    <td>Decoración para bodas y eventos</td>
                                    <td>3500000</td>
                                    <td class="action-buttons">
                                        <button class="btn btn-sm btn-primary">Ver</button>
                                        <button class="btn btn-sm btn-warning">Editar</button>
                                ...
                                <tr>
                                    ...
                                    <td>Fotografía profesional para eventos</td>
                                    <td>4500000</td>
                                    <td class="action-buttons">
                                        <button class="btn btn-sm btn-primary">Ver</button>
                                        <button class="btn btn-sm btn-warning">Editar</button>
