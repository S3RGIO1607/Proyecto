...
<head>
    ...
    <title>Registro de Producto - Casa de Eventos Aaron</title>
    ...
    <div class="container">
        <nav class="b">
            ...
            <ul class="f">
                ...
                <li class="g">
                    ...
                    <ul class="j">
                        <li>
                            <a href="#" target="_self">Registrar</a>
                        </li>
                        <li>
                            <a href="../vista/404.html" target="_self">Consultar</a>
                        </li>
        ...
        <body class="Tab_Registro">
            <div class="container_RU">
                <h2 class="RU">Registro de Paquete</h2>
                <form action="../controlador/controlador_paquete.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="tipo_evento">Tipo de Evento</label>
                        <select class="form-control" id="tipo_evento" name="tipo_evento" required>
                            <option value="">Seleccione un tipo de evento</option>
                            <option value="Paquete Clásico">Paquete Clásico</option>
                            <option value="Paquete Premium">Paquete Premium</option>
                            <option value="Paquete Corporativo">Paquete Corporativo</option>
                            <option value="Paquete Boda">Paquete Boda</option>
                            <option value="Paquete Fiesta Infantil">Paquete Fiesta Infantil</option>
                            <option value="Paquete Aniversario">Paquete Aniversario</option>
                            <option value="Paquete Graduación">Paquete Graduación</option>
                            <option value="Paquete Fiesta de Fin de Año">Paquete Fiesta de Fin de Año</option>
                        </select>
                    </div>
                    <div class="form-group">
